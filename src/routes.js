...
import BulkStudentEntryPage from './components/BulkStudentEntryForm/index.js';
...
const Routes = (props) => (
  <Switch {...props}>
    ...
    <PrivateRoute adminRoute="true" path="/admin/bulk-student-entry" component={BulkStudentEntryPage} />
